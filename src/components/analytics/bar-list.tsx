...
export const BarListItem = ({ item, total }: { item: Bar; total: number }) => {
  return (
    <Comp
      as={item.href ? "Link" : "div"}
      href={item.href}
      target="_blank"
      className="relative flex min-h-[30px] h-4.5 w-full  items-center justify-between overflow-hidden rounded-md  px-2 py-1 transition-colors hover:bg-gray-3"
    >
